...
class TMWPage00 extends StatelessWidget {
  final List<charts.Series> seriesList;
  final bool animate;

  TMWPage00(this.seriesList, {this.animate});

  factory TMWPage00.withSampleData() {
    return new TMWPage00(
      _createSampleData(),
  ...
  factory TMWPage00.withRandomData() {
    return new TMWPage00(_createRandomData());
  }

  factory TMWPage00.withTMWData(Map<String, dynamic> map) {
