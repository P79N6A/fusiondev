...
class QMPersonCenter extends StatelessWidget {
  ...
  final Function(BuildContext,QMPersonItem) onClickFab;
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new _QMPersonCenter(bgImage: bgImage,desc:desc,user:user,onTap: onTap,onClickFab: onClickFab),
    );
  }
}
...
class _QMPersonCenter extends StatefulWidget {
  ...
  final void Function(BuildContext,QMPersonItem) onClickFab;
  _QMPersonCenter({Key key,this.bgImage,this.desc,this.user,this.onTap,this.onClickFab}) : super(key: key);
...
class _MainPageState extends State<_QMPersonCenter> {
  ...
  void _changeFilterState() {
    ...
    if(widget.onClickFab != null){
      QMPersonItem item = new QMPersonItem();
      item.showOnlyCompleted = showOnlyCompleted;
      widget.onClickFab(context,item);
    }else{
...
class QMPersonItem {
  ...
  QMPersonItem({this.id,this.name, this.category, this.time, this.color, this.completed});
}
