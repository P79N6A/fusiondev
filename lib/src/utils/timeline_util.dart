...
class QMTimelineUtil {
  ...
  static String format(int timeMillis,
    ...
    if (_info.customYesterday().isNotEmpty &&
        QMDateUtil.isYesterdayByMillis(timeMillis, _locTimeMillis)) {
      return _getYesterday(timeMillis, _info, _dayFormat);
    }

    if (!QMDateUtil.yearIsEqualByMillis(timeMillis, _locTimeMillis)) {
  ...
  static String _getYesterday(
    ...
    return info.customYesterday() +
        (dayFormat == DayFormat.Full
            ? (" " +
                QMDateUtil.getDateStrByMs(timeMillis,
  ...
  static String _getYear(int timeMillis, DayFormat dayFormat) {
    if (dayFormat != DayFormat.Simple) {
      return QMDateUtil.getDateStrByMs(timeMillis,
  ...
  static String _formatDays(int timeMillis, num days, TimelineInfo timelineInfo,
    ...
    switch (dayFormat) {
      ...
      case DayFormat.Common:
        timeline =
            QMDateUtil.getDateStrByMs(timeMillis, format: DateFormat.MONTH_DAY);
        break;
      case DayFormat.Full:
        timeline = QMDateUtil.getDateStrByMs(timeMillis,
