...
import 'package:fusion_dev/src/service/testresponse.dart';
...
//要查网络请求的日志可以使用过滤<net>
class QMHttpService {
  static const String TAG = "QMHttpService";
  static const String GET = "get";
  static const String POST = "post";
  //get请求
  static Future<QMRsp> get(String url,
      {
      QMReq data,
      Function errorCallBack
      }) async {
        Map<String, dynamic> params = data.toJson();
    return _request(QMApp.getBaseURL() + url,
        method: GET,
        params: params);
  }
  static Future<Object> doGet(String url,
    {
    ...
    String reqUrl = '';
        if(url.indexOf('http://')!=-1 || url.indexOf('https://') !=-1){
          ...
          reqUrl = QMApp.getBaseURL() + url;
        }
    return _request2(reqUrl,method: GET,params: data);
  }
  //post请求
  static Future<QMRsp> post(String url,
      {
      QMReq data,
    ...
    return await _request(reqUrl,
        method: POST,
        params: params);
  }
  
  static Future<Object> doPost(String url,
      {
      Map<String,dynamic> data,
      Function errorCallBack}) async {
        String reqUrl = '';
  ...
  //具体的还是要看返回数据的基本结构
  //公共代码部分
  static Future<QMRsp> _request(String url,
      {
      String method,
      Map<String, dynamic> params,
      Function errorCallBack}) async {
      QMLogUtil.v("<net> url :<" + method + ">" + url,tag:QMHttpService.TAG);

    if (params != null && params.isNotEmpty) {
      QMLogUtil.v("<net> params :" + params.toString(),tag:QMHttpService.TAG);
    }
    ...
    try {
      ...
      if (statusCode < 0) {
        ...
        QMRsp rsp = QMRsp.fromJson({"resultState": statusCode.toString(), "exMessage": errorMsg});
        rsp.exMessage = errorMsg;
        return rsp;
      }
      ...
      QMRsp rsp = QMRsp.fromJson(data);
      QMLogUtil.v("<net> response data:" + rsp.getData().toString(),tag:QMHttpService.TAG);
      return rsp;
    } catch (exception) {
      _handError(errorCallBack, exception.toString());
      QMRsp rsp = QMRsp.fromJson({'resultState':'-1','exMessage':errorMsg});
      rsp.exMessage = errorMsg;
      throw exception;
    }
  }
  ...
  //   static Future<T> _request1<T extends testresponse>(String url,
  //     {
  //     String method,
  //     Map<String, dynamic> params,
  //     Function errorCallBack}) async {
  ...
  //       errorMsg = "网络请求错误,状态码:" + statusCode.toString();
  //       _handError(errorCallBack, errorMsg);
  //       T rsp = T.fromJson({"resultState": statusCode.toString(), "exMessage": errorMsg});
  //       rsp.exMessage = errorMsg;
  //       return rsp;
  //     }
  ...
  static Future<Object> _request2(String url,
    {
      String method,
      Map<String,dynamic> params,
      Function errorCallBack}) async {
    ...
    try {
      ...
      // QMRsp rsp = QMRsp.fromJson(data);
      QMLogUtil.v("<net> response data:" + data.toString(),tag:QMHttpService.TAG);
      return data;
    } catch (exception) {
      _handError(errorCallBack, exception.toString());
      QMRsp rsp = QMRsp.fromJson({'resultState':'-1','exMessage':errorMsg});
  ...
  static void _handError(Function errorCallback, String errorMsg) {
    ...
    QMLogUtil.e("<net> errorMsg ::" + errorMsg,tag:QMHttpService.TAG);
...
//   String exMessage;
//   int resultState;
//   int upTime; //":7535698598,
//   int downTime; //7535698602,
...
//     return Map.castFrom(this.getData())[key];
//   }
...
//     _request(QMApp.getBaseURL() + url, callBack,
...
//       if (callBack != null) {
//         Map<String, dynamic> data = response.data;
//         QMRsp QMRsp = new QMRsp(response);
